...
public:
    ...
    void setupUi(QDialog *FindAndReplace)
    {
        ...
        FindAndReplace->setPalette(palette);
        ...
        registerBox = new QCheckBox(FindAndReplace);
        registerBox->setObjectName(QString::fromUtf8("registerBox"));
        registerBox->setGeometry(QRect(20, 200, 150, 20));
    ...
    void retranslateUi(QDialog *FindAndReplace)
    {
        ...
        registerBox->setText(QCoreApplication::translate("FindAndReplace", "Strict register", nullptr));
    } // retranslateUi
